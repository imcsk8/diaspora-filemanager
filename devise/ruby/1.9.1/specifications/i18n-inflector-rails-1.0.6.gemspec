...
Gem::Specification.new do |s|
  ...
  s.date = "2011-08-09"
  s.description = "Plug-in that provides I18n Inflector module integration with Rails."
  s.email = ["pw@gnu.org"]
  s.extra_rdoc_files = ["Manifest.txt"]
  s.files = ["Manifest.txt"]
  s.homepage = "https://rubygems.org/gems/i18n-inflector-rails/"
  s.rdoc_options = ["--title", "I18n::Inflector::Rails Documentation", "--quiet"]
  s.require_paths = ["lib"]
  s.rubyforge_project = "i18n-inflector-rails"
  s.rubygems_version = "1.8.11"
  s.summary = "I18n Inflector bindings for Rails"
